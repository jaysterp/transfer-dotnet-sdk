...
namespace Containerregistry.Models
{
    ...
    public partial class PipelineRunRequest
    {
        ...
        /// the artifacts.</param>
        /// <param name="isArchiveEnabled">Indicates whether archiving is
        /// enabled for the pipeline run or not.</param>
        public PipelineRunRequest(string pipelineResourceId = default(string), IList<string> artifacts = default(IList<string>), PipelineRunSourceProperties source = default(PipelineRunSourceProperties), PipelineRunTargetProperties target = default(PipelineRunTargetProperties), string catalogDigest = default(string), bool? isArchiveEnabled = default(bool?))
        {
        ...
        /// <summary>
        /// Gets or sets indicates whether archiving is enabled for the
        /// pipeline run or not.
        /// </summary>
